                ...
                <nav className="w-full flex justify-between gap-6 relative">
                    ...
                    <div className="min-w-max inline-flex relative">
                        <a href="/" className="relative flex items-center gap-3">
                            <img src={logo} alt="CromeAI" className="w-10 h-10" />
                    ...
                    <div className="min-w-max flex items-center gap-x-3">
                        <button onClick={toggleTheme} className="ouline-hidden flex relative text-heading-2 rounded-full p-2 lg:p-3 border border-box-border corsor-pointer">
                            {
                                theme == "dark" ? (
                                    <svg
